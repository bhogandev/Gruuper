...
namespace BibleVerseAPI.Controllers
{
    ...
    {
        private readonly FirebaseRepository _repository;
        private readonly ELogRepository _elogRepository;
        private string serviceBase = "Firebase";
        private string context = String.Empty;

        public FirebaseController(FirebaseRepository repository, ELogRepository eLogRepository)
        {
